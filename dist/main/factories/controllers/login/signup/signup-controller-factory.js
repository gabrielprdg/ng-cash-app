...
const makeSignUpController = () => {
    return new signup_controller_1.SignUpController((0, add_user_factory_1.makeAddUser)(), (0, authentication_factory_1.makeDbAuthentication)(), (0, signup_validation_factory_1.makeSignUpValidation)());
};
